...
class CommonPoolView extends HBox
{
    private PoolIndicator commonPoolIndicator;
    ...
    void initializeView()
    {
        commonPoolIndicator = new PoolIndicator(Direction.RIGHT);
        VBox poolIndicatorBox = (VBox) commonPoolIndicator.getIndicator(PoolIndicator.State.OFF);

        VBox pool = getPoolView(Color.rgb(161,205,247));
    ...
    {
        Label titleLabel = new Label("Common Pool");
    ...
    {
        VBox poolIndicatorBox = (VBox) commonPoolIndicator.getIndicator(poolState);
